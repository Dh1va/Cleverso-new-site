...
useEffect(() => {
  ...
  return (
    ...
    {/* Loader */}
      ...
      {/* Section - Inner Page Statistics */}
      <div   ref={statsSectionRef} className="mxd-section mxd-section-inner-stats overflow-hidden">
        <div className="mxd-container grid-container">
      ...
      <div className="mxd-services-list grid-top hover-reveal">
        ...
        <div className="mxd-services-list__item hover-reveal__item">
          ...
          <div className="hover-reveal__content hover-reveal-360x440">
            <img
              ...
              src="img/illustrations/360x440_list-01.webp"
              alt=""
            />
          </div>
                ...
                <div className="col-12 col-xl-3 mxd-grid-item no-margin">
                  <div className="mxd-services-list__descr anim-uni-in-up">
                    <p>
                      ...
                      we make sure your brand’s visuals resonate with your audience.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="mxd-services-list__tagslist">
                    <ul>
                      {[
                        ...
                        <li key={tag} className="anim-uni-in-up">
                          <p>{tag}</p>
                        </li>
                      ))}
                    </ul>
        ...
        <div className="mxd-services-list__item hover-reveal__item">
          ...
          <div className="hover-reveal__content hover-reveal-360x440">
            <img
              className="hover-reveal__image"
              src="img/illustrations/360x440_list-02.webp"
              alt=""
            />
          </div>
                ...
                <div className="col-12 col-xl-3 mxd-grid-item no-margin">
                  <div className="mxd-services-list__descr anim-uni-in-up">
                    <p>
                      ...
                      technologies. Our solutions are designed to be scalable and functional
        ...
        <div className="mxd-services-list__item hover-reveal__item">
          ...
          <div className="hover-reveal__content hover-reveal-360x440">
            <img
              className="hover-reveal__image"
              src="img/illustrations/360x440_list-03.webp"
              alt=""
            />
          </div>
                ...
                <div className="col-12 col-xl-3 mxd-grid-item no-margin">
                  <div className="mxd-services-list__descr anim-uni-in-up">
                    <p>
                      ...
                      business stands out with a unique visual identity and consistent
        ...
        <div className="mxd-services-list__item hover-reveal__item">
          ...
          <div className="hover-reveal__content hover-reveal-360x440">
            <img
              className="hover-reveal__image"
              src="img/illustrations/360x440_list-04.webp"
              alt=""
            />
          </div>
            ...
            <div className="container-fluid px-0">
              <div className="row gx-0">
                ...
                <div className="col-12 col-xl-3 mxd-grid-item no-margin">
                  <div className="mxd-services-list__descr anim-uni-in-up">
                    <p>
                      We develop and execute tailored digital marketing strategies. SEO and
                      content marketing, social media management and paid campaigns help you
    ...
    <div className="mxd-divider">
      <div className="mxd-divider__video">
        <video
          ...
          loop
          muted
          poster="/assets/video/1920x1080_video-07.webp"
        >
          <source src="/assets/video/1920x1080_video-07.mp4" type="video/mp4" />
          <source src="/assets/video/1920x1080_video-07.webm" type="video/webm" />
          <source src="/assets/video/1920x1080_video-07.ogv" type="video/ogv" />
        </video>
      </div>
            ...
            <div className="col-12 col-xl-4 mxd-grid-item no-margin">
              <div className="mxd-section-title__hrdescr">
                <p className="anim-uni-in-up">
                  Inspiring ideas, creative insights, and the latest in design and
                  tech. Fueling innovation for your digital journey.
                </p>
              </div>
            </div>
        ...
        <div className="container-fluid p-0">
          <div className="row g-0">
            ...
            <div className="col-12 col-xl-4 mxd-blog-preview__item mxd-grid-item animate-card-3">
              ...
              <div className="mxd-blog-preview__data">
                <a className="anim-uni-in-up" href="blog-article.html">
                  Elevating <span>digital workshops</span> with engaging design
                </a>
              </div>
            </div>
