                  ...
                  <div className="mxd-block__content">
                    <div className="mxd-block__inner-headline loading__item">
                      ...
                      <a
                        ...
                        href="mailto:hello@rayo.com?subject=Message%20from%20your%20site"
                      >
                        <span className="btn-caption">hello@rayo.com</span>
                        {/* Replaced i tag with an SVG arrow for reliability */}
                        <svg
                          width="14"
                          height="14"
                          viewBox="0 0 256 256"
            ...
            <div className="marquee marquee-right--gsap muted-extra">
              <div className="marquee__toright">
                {[1, 2, 3, 4].map((_, i) => (
                  ...
                  c-1.9,0.5-4.7,0.6-6.7,0.8c-3.9,0.4-16.6,0-16.6,0C0.8,38.4,0,39.2,0,40s0.8,1.6,1.6,1.6h16.6
                  c1.6,0,4.8,0.3,6.7,0.8c2.3,0.6,4.3,0.8,6.3,2.4
                  c1.6,1.2,3.2,2.8,4.3,4.4c1.2,2,2.1,3.9,2.4,6.3
                  c0.2,1.7,0.7,4.7,0.8,6.7c0.2,4,0,16.2,0,16.2
                  c0,0.8,0.8,1.6,1.6,1.6s1.6-0.8,1.6-1.6V62.2
                  c0-1.6,0.5-5.1,0.8-6.7c0.5-2.3,0.8-4.4,2.4-6.3
                  c1.2-1.6,2.8-3.2,4.3-4.4c2-1.2,3.9-2,6.3-2.4
                  c1.8-0.3,5.1-0.7,7.1-0.8c3.5-0.2,15.8,0,15.8,0
                  c0.8,0,1.6-0.8,1.6-1.6S79.2,38.4,78.4,38.4z"
                        />
                      </svg>
                    </div>
                  </div>
            ...
            <div className="mxd-links-lines">
              {[
                ...
                <div key={index} className="mxd-links-lines__item">
                  ...
                  {/* Added 'slide-right-up' for the template's arrow animation */}
                  <a
                    className="mxd-links-lines__link anim-uni-in-up slide-right-up"
                    href={item.url}
                    target="_blank"
                    rel="noreferrer"
                  >
                  ...
                  <div className="mxd-block__content">
                    <div className="mxd-block__paragraph">
                      <p className="t-large t-bright anim-uni-in-up">
                        Inspiring ideas, creative insights,
                        <br />
                        and the latest in design and tech. Fueling innovation
