...
export default function Home() {
  const [counts, setCounts] = React.useState({ c1: 0, c2: 0, c3: 0, c4: 0 });
  const sectionRef = React.useRef(null);
  const targets = { c1: 250, c2: 98, c3: 12, c4: 400 };
      ...
      (entries) => {
        if (entries[0].isIntersecting) {
          ...
          const step = (timestamp) => {
            ...
            setCounts({
              c1: Math.floor(targets.c1 * easeOut(progress)),
              c2: Math.floor(targets.c2 * easeOut(progress)),
              c3: Math.floor(targets.c3 * easeOut(progress)),
              c4: Math.floor(targets.c4 * easeOut(progress)),
            });
          ...
          // Reset counts when it leaves the screen so it can replay
          setCounts({ c1: 0, c2: 0, c3: 0, c4: 0 });
        }
      },
      { threshold: 0.2 }
  ...
  return (
    <>
      ...
      <main id="mxd-page-content" className="mxd-page-content">
              ...
              <div className="mxd-hero-03__top">
                    ...
                    <div className="marquee__toright">
                      ...
                      <div className="marquee__item one-line">
                        <div className="hero-03-marquee__video">
                          <video
                            ...
                            loop
                            muted
                            poster="/assets/video/hero/hero-video-02.webp"
                          >
                            <source
                              type="video/mp4"
                              src="/assets/video/hero/hero-video-02.mp4"
                            />
                            <source
                              type="video/webm"
                              src="/assets/video/hero/hero-video-02.webm"
                            />
                            <source
                              type="video/ogv"
                              src="/assets/video/hero/hero-video-02.ogv"
                            />
                          </video>
                        </div>
                      </div>
                      ...
                      <div className="marquee__item one-line">
                        <div className="hero-03-marquee__image">
                          <img
                            className="mxd-move"
                            src="/assets/img/hero/29_hero-img.webp"
                            alt="Image"
                          />
                        </div>
                      </div>
                      ...
                      <div className="marquee__item one-line">
                        <div className="hero-03-marquee__video">
                          <video
                            ...
                            loop
                            muted
                            poster="/assets/video/hero/hero-video-01.webp"
                          >
                            <source
                              type="video/mp4"
                              src="/assets/video/hero/hero-video-01.mp4"
                            />
                            <source
                              type="video/webm"
                              src="/assets/video/hero/hero-video-01.webm"
                            />
                            <source
                              type="video/ogv"
                              src="/assets/video/hero/hero-video-01.ogv"
                            />
                          </video>
                        </div>
                      </div>
                      ...
                      <div className="marquee__item one-line">
                        <div className="hero-03-marquee__image">
                          <img
                            ...
                            src="/assets/img/hero/28_hero-img.webp"
                            alt="Image"
                          />
                        </div>
                      </div>
                      ...
                      <div className="marquee__item one-line">
                        <div className="hero-03-marquee__image">
                          <img
                            className="mxd-move"
                            src="/assets/img/hero/30_hero-img.webp"
                            alt="Image"
                          />
                        </div>
                      </div>
                      ...
                      <div className="marquee__item one-line">
                        <div className="hero-03-marquee__image">
                          <img
                            ...
                            src="/assets/img/hero/24_hero-img.webp"
                            alt="Image"
                          />
                        </div>
                      </div>
                ...
                <div className="mxd-hero-03__headline">
                  ...
                  <h1 className="hero-03-headline__title loading__item">
                    <span className="hero-03-headline__hidden">
                      Rayo Studio
                    </span>
                    ...
                    <svg
                      ...
                      style={{ enableBackground: "new 0 0 238.2 108.3" }}
                      xmlSpace="preserve"
                    >
                      <path
                  ...
                  <div className="mxd-divider">
                    <div className="mxd-divider__video">
                      <video
                        ...
                        loop
                        muted
                        poster="/assets/video/1920x1080_video-04.webp"
                      >
                        <source
                          src="/assets/video/1920x1080_video-04.mp4"
                          type="video/mp4"
                        />
                        <source
                          src="/assets/video/1920x1080_video-04.webm"
                          type="video/webm"
                        />
                      </video>
                    </div>
                    ...
                    <div className="col-12 col-xl-8 mxd-services-cards-s__item mxd-grid-item anim-uni-scale-in-right">
                      <div className="mxd-services-cards-s__inner justify-between bg-base-tint radius-l padding-4">
                        ...
                        <div className="mxd-services-cards-s__image image-right">
                          <img
                            src="/assets/img/illustrations/1200x1200_service-image-01.webp"
                            alt="Illustration"
                          />
                        </div>
                      </div>
                      ...
                      <div className="mxd-services-cards-s__inner justify-end bg-accent radius-l padding-4">
                        ...
                        <div className="mxd-services-cards-s__info">
                          ...
                          <p className="t-opposite anim-uni-in-up">
                            ...
                            to payment processing and investment platforms.
                          </p>
                        </div>
                        ...
                        <div className="mxd-services-cards-s__image image-top-right">
                          <img
                            className="mxd-move"
                            src="/assets/img/illustrations/1200x1200_service-image-02.webp"
                            alt="Illustration"
                          />
                        </div>
                      </div>
                    ...
                    <div className="col-12 col-xl-4 mxd-services-cards-s__item mxd-grid-item anim-uni-scale-in-right">
                      <div className="mxd-services-cards-s__inner bg-additional radius-l padding-4">
                        ...
                        <div className="mxd-services-cards-s__image image-bottom">
                          <img
                            className="mxd-rotate-slow"
                            src="/assets/img/illustrations/1200x1200_service-image-03.webp"
                            alt="Illustration"
                          />
                        </div>
                      </div>
                    ...
                    <div className="col-12 col-xl-4 mxd-services-cards-s__item mxd-grid-item anim-uni-scale-in">
                      <div className="mxd-services-cards-s__inner bg-base-opp radius-l padding-4">
                        ...
                        <div className="mxd-services-cards-s__image image-bottom image-bottom-2">
                          <img
                            src="/assets/img/illustrations/1200x1200_service-image-04.webp"
                            alt="Illustration"
                          />
                        </div>
                      </div>
                    ...
                    <div className="col-12 col-xl-4 mxd-services-cards-s__item mxd-grid-item anim-uni-scale-in-left">
                      <div className="mxd-services-cards-s__inner justify-end bg-base-tint radius-l padding-4">
                        ...
                        <div className="mxd-services-cards-s__info">
                          ...
                          <p className="anim-uni-in-up">
                            Immersive experiences, multiplayer platforms, and
                        ...
                        <div className="mxd-services-cards-s__image image-top">
                          <img
                            src="/assets/img/illustrations/1200x1200_service-image-05.webp"
                            alt="Illustration"
                          />
                        </div>
                      </div>
        ...
        {/* Section - Our Capabilities List Large Start */}
        <section className="mxd-section overflow-hidden padding-grid-pre-pinned">
          <div className="mxd-container grid-container">
                    ...
                    <div className="col-12 col-xl-3 mxd-grid-item no-margin">
                      <div className="mxd-section-title__hrcontrols anim-uni-in-up">
                        <a
                          ...
                          href="services.html"
                        >
                          <span className="btn-caption">All Services</span>
                          {/* Optimized SVG replacement for ph-arrow-up-right */}
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="1em"
                    ...
                    <div className="mxd-cpb-list">
                      ...
                      <div className="mxd-cpb-list__item hover-reveal__item">
                        ...
                        <div className="hover-reveal__content hover-reveal-280x340">
                          <img
                            ...
                            src="/assets/img/illustrations/600x730_cpb-01.webp"
                            alt="Project Preview"
                          />
                        </div>
                        ...
                        <div className="mxd-cpb-list__image anim-uni-in-up">
                          <img
                            src="/assets/img/illustrations/1200x800_cpb-01.webp"
                            alt="Project Preview"
                          />
                        </div>
                        <div className="mxd-cpb-list__divider anim-uni-in-up"></div>
                      ...
                      <div className="mxd-cpb-list__item hover-reveal__item">
                        ...
                        <div className="hover-reveal__content hover-reveal-280x340">
                          <img
                            className="hover-reveal__image"
                            src="/assets/img/illustrations/600x730_cpb-03.webp"
                            alt="Project Preview"
                          />
                        </div>
                        <div className="mxd-cpb-list__content anim-uni-in-up">
                        ...
                        <div className="mxd-cpb-list__image anim-uni-in-up">
                          <img
                            src="/assets/img/illustrations/1200x800_cpb-03.webp"
                            alt="Project Preview"
                          />
                        </div>
                        <div className="mxd-cpb-list__divider anim-uni-in-up"></div>
                      ...
                      <div className="mxd-cpb-list__item hover-reveal__item">
                        ...
                        <div className="hover-reveal__content hover-reveal-280x340">
                          <img
                            className="hover-reveal__image"
                            src="/assets/img/illustrations/600x730_cpb-02.webp"
                            alt="Project Preview"
                          />
                        </div>
                        <div className="mxd-cpb-list__content anim-uni-in-up">
                        ...
                        <div className="mxd-cpb-list__image anim-uni-in-up">
                          <img
                            src="/assets/img/illustrations/1200x800_cpb-02.webp"
                            alt="Project Preview"
                          />
                        </div>
                        <div className="mxd-cpb-list__divider anim-uni-in-up"></div>
                      ...
                      <div className="mxd-cpb-list__item hover-reveal__item">
                        ...
                        <div className="hover-reveal__content hover-reveal-280x340">
                          <img
                            className="hover-reveal__image"
                            src="/assets/img/illustrations/600x730_cpb-04.webp"
                            alt="Project Preview"
                          />
                        </div>
                        <div className="mxd-cpb-list__content anim-uni-in-up">
                        ...
                        <div className="mxd-cpb-list__image anim-uni-in-up">
                          <img
                            src="/assets/img/illustrations/1200x800_cpb-04.webp"
                            alt="Project Preview"
                          />
                        </div>
                        <div className="mxd-cpb-list__divider anim-uni-in-up"></div>
                      ...
                      <div className="mxd-cpb-list__item hover-reveal__item">
                        ...
                        <div className="hover-reveal__content hover-reveal-280x340">
                          <img
                            className="hover-reveal__image"
                            src="/assets/img/illustrations/600x730_cpb-05.webp"
                            alt="Project Preview"
                          />
                        </div>
                        <div className="mxd-cpb-list__content anim-uni-in-up">
                        ...
                        <div className="mxd-cpb-list__image anim-uni-in-up">
                          <img
                            src="/assets/img/illustrations/1200x800_cpb-05.webp"
                            alt="Project Preview"
                          />
                        </div>
                        <div className="mxd-cpb-list__divider anim-uni-in-up"></div>
                      ...
                      <div className="mxd-cpb-list__item hover-reveal__item">
                        ...
                        <div className="hover-reveal__content hover-reveal-280x340">
                          <img
                            className="hover-reveal__image"
                            src="/assets/img/illustrations/600x730_cpb-06.webp"
                            alt="Project Preview"
                          />
                        </div>
                        <div className="mxd-cpb-list__content anim-uni-in-up">
                        ...
                        <div className="mxd-cpb-list__image anim-uni-in-up">
                          <img
                            src="/assets/img/illustrations/1200x800_cpb-06.webp"
                            alt="Project Preview"
                          />
                        </div>
                        <div className="mxd-cpb-list__divider anim-uni-in-up"></div>
                      ...
                      <div className="mxd-cpb-list__item hover-reveal__item">
                        ...
                        <div className="hover-reveal__content hover-reveal-280x340">
                          <img
                            className="hover-reveal__image"
                            src="/assets/img/illustrations/600x730_cpb-07.webp"
                            alt="Project Preview"
                          />
                        </div>
                        <div className="mxd-cpb-list__content anim-uni-in-up">
                        ...
                        <div className="mxd-cpb-list__image anim-uni-in-up">
                          <img
                            src="/assets/img/illustrations/1200x800_cpb-07.webp"
                            alt="Project Preview"
                          />
                        </div>
                        <div className="mxd-cpb-list__divider anim-uni-in-up"></div>
        ...
        {/* Section - Our Capabilities List Large End */}

        {/* Section - Projects Pinned #02 Start */}
        <div className="mxd-section padding-pre-grid mobile-grid-title">
          <div className="mxd-container grid-container">
                            ...
                            <div className="row g-0">
                              <div className="col-12 mxd-grid-item no-margin">
                                <div className="mxd-section-title__title">
                                  <h2 className="reveal-type">Case studies</h2>
                                </div>
                              </div>
                          ...
                          <div className="mxd-project-item__promo">
                            <div className="mxd-project-item__name">
                              <a
                                ...
                                href="project-details.html"
                              >
                                <span>Interactive concept</span> powered by AI
                              </a>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="mxd-project-item__promo">
                            <div className="mxd-project-item__name">
                              <a href="project-details.html">
                                <span>Mobile app design</span> for a
                          ...
                          <div className="mxd-project-item__promo">
                            <div className="mxd-project-item__name">
                              <a
                                ...
                                href="project-details.html"
                              >
                                <span>NFT project</span> branding
                              </a>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="mxd-project-item__promo">
                            <div className="mxd-project-item__name">
                              <a
                                ...
                                href="project-details.html"
                              >
                                <span>Illustrations set</span> for digital and
                                print use
                              </a>
                            </div>
                          </div>
            ...
            {/* Block - Projects Pinned #01 with Section Title End */}
          </div>
        </div>
        {/* Section - Projects Pinned #02 End */}
        ...
        <div className="mxd-section padding-default" ref={sectionRef}>
          <div className="mxd-container grid-container">
              ...
              <div className="mxd-stats-simple">
                <div className="container-fluid p-0">
                  <div className="row g-0 mxd-stats-simple">
                    {/* item 01 */}
                    <div className="col-12 col-lg-3 mxd-stats-simple__item mxd-grid-item">
                      <div className="mxd-stats-simple__inner animate-card-4">
                        <div className="mxd-counter">
                          <p className="mxd-stats-number mxd-stats-simple__counter">
                            {counts.c1}
                          </p>
                        </div>
                        <img
                          className="mxd-stats-simple__image"
                          src="img/icons/h70_stats-01.webp"
                          alt="Icon"
                        />
                    ...
                    <div className="col-12 col-lg-3 mxd-stats-simple__item mxd-grid-item">
                      <div className="mxd-stats-simple__inner animate-card-4">
                        ...
                        <img
                          className="mxd-stats-simple__image"
                          src="img/icons/h70_stats-02.webp"
                          alt="Icon"
                        />
                        <p className="mxd-stats-simple__descr t-140 t-bright">
                    ...
                    <div className="col-12 col-lg-3 mxd-stats-simple__item mxd-grid-item">
                      <div className="mxd-stats-simple__inner animate-card-4">
                        ...
                        <img
                          className="mxd-stats-simple__image"
                          src="img/icons/h70_stats-03.webp"
                          alt="Icon"
                        />
                        <p className="mxd-stats-simple__descr t-140 t-bright">
                    ...
                    <div className="col-12 col-lg-3 mxd-stats-simple__item mxd-grid-item">
                      <div className="mxd-stats-simple__inner animate-card-4">
                        ...
                        <img
                          className="mxd-stats-simple__image"
                          src="img/icons/h70_stats-04.webp"
                          alt="Icon"
                        />
                        <p className="mxd-stats-simple__descr t-140 t-bright">
                          Successfully
                ...
                <div className="container-fluid p-0">
                  <div className="row g-0">
                    ...
                    <div className="col-12 col-xl-4 mxd-blog-preview__item mxd-grid-item animate-card-3">
                      ...
                      <div className="mxd-blog-preview__data">
                        <a className="anim-uni-in-up" href="/blog/article">
                          Branding in creating <span>digital experiences</span>
                        </a>
                      </div>
                    </div>
